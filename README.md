...
9. [Trial vs. Paid Features](#trial-vs-paid-features)
...
Attachment Architect helps Jira administrators **eliminate storage waste** by finding and removing duplicate attachments. It's like having a smart assistant that:

- 🔍 **Scans** your entire Jira instance for attachments
- 📊 **Analyzes** storage usage patterns
- 🎯 **Identifies** duplicate files wasting space
- 🧹 **Cleans** up duplicates with one click
...
```
[https://marketplace.atlassian.com/apps/2464899201/attachment-architect](https://marketplace.atlassian.com/apps/2464899201/attachment-architect)
```
...
2. Click the **"Start New Scan"** button
...
- ✅ Analyzes storage patterns by project, user, file type, etc.
...
- **Waste percentage** (duplicates / total)
- **Quick wins** - Top 3 files with highest impact
